...
public class ZBar {
	...
	static{
		try {
			zbar_image_scanner_create = new JNative(dll,"zbar_image_scanner_create");	
  ...
  public static byte[] getY800(BufferedImage originalPic){
	...
	public static void main(String[] argv){
		...
		try {
			BufferedImage   srcImage   =   ImageIO.read(new   File( "D:\\study\\java\\jar zip\\javabar\\sampleBarCodeImages\\upc\\barcodeCollage2.jpg"));
